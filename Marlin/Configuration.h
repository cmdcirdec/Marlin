...
#define STRING_CONFIG_H_AUTHOR "(cmdcirdec, Sidewinder X1)" // Who made the changes.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 5   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
